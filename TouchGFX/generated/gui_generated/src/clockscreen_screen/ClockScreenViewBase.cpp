    ...
    updateItemCallback(this, &ClockScreenViewBase::updateItemCallbackHandler)
{
    ...
    btnSetupClock.setBoxWithBorderPosition(0, 0, 394, 72);
    ...
    containerClock.setPosition(4, 80, 792, 324);

    contClockSettings.setPosition(8, 18, 478, 284);

    boxWithBorder2.setPosition(0, 0, 478, 284);
    ...
    scrollYear.setPosition(188, 74, 100, 200);
    ...
    scrollHour.setPosition(312, 74, 100, 200);
    ...
    scrollMin.setPosition(382, 74, 100, 200);
    ...
    lineHeader.setPosition(0, 57, 478, 17);
    ...
    lineSelector0.setPosition(10, 142, 458, 15);
    ...
    lineSelector1.setPosition(10, 202, 458, 16);
    ...
    lineSelector0_1.setPosition(497, 263, 284, 16);
    ...
    lbClockCurrentDate.setXY(561, 115);
    ...
    lbClockCurrentTime.setXY(586, 167);
    ...
    lineSelector0_1_1.setPosition(497, 100, 284, 15);
