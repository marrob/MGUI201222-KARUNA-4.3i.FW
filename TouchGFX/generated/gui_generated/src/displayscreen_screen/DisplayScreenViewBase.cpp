    ...
    radioButtonSelectedCallback(this, &DisplayScreenViewBase::radioButtonSelectedCallbackHandler)
{
    ...
    textArea1.setPosition(0, 8, 800, 72);
    ...
    btnDisplayOff.setBoxWithBorderPosition(0, 0, 394, 72);
    ...
    btnDisplayOff.setBitmapXY(20, 5);
    btnDisplayOff.setText(TypedText(T___SINGLEUSE_BX5F));
    btnDisplayOff.setTextPosition(-20, 20, 394, 72);
    ...
    container1.setPosition(25, 111, 771, 289);

    sldrBrightnes.setXY(13, 238);
    ...
    lblBrightness.setPosition(648, 203, 77, 44);
    ...
    textArea2_1_1_1.setPosition(507, 203, 144, 44);
    ...
    lblTimeToOff.setPosition(507, 15, 267, 42);
    ...
    chbxEnableScreenSaver.setXY(13, 181);
    ...
    lblScreenSaverEnable.setPosition(68, 183, 346, 42);
    ...
    line1.setPosition(42, 284, 710, 15);
